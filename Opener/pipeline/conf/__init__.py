...
exec_py = 'D:/Projet/PullGithub/Python-in-DCC/Alembic/maya/exec_py.mel' # (include in the project : Alembic/maya)


# ======== HOUDINI SETTINGS ========
hython = 'F:/Program_Files/Houdini_18.0.499/bin/hython.exe'
